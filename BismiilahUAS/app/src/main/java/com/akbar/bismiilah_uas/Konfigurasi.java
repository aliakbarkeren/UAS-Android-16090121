package com.akbar.bismiilah_uas;

public class Konfigurasi {
    public static final String URL_ADD="http://192.168.43.4/from/tambah.php";
    public static final String URL_GET_ALL="http://192.168.43.4/from/tampil.php";
